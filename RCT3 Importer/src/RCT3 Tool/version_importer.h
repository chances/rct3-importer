...
namespace AutoVersion{
	...
	static const long BUILD = 496;									// av::var:post
	static const long REVISION = 1322;								// av::var:pre
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT = 1263;							// Ignore as cruft
	#define RC_FILEVERSION 18,2,496,1322								// av::multi:major:minor:post:pre:"%1%,%2%,%3%,%4%"
	#define RC_FILEVERSION_STRING "18, 2, 496, 1322\0"				// av::multi:major:minor:post:pre:"%1%, %2%, %3%, %4%\0"
	static const char FULLVERSION_STRING[] = "18.2.496.1322";		// av::multi:major:minor:post:pre:"%1%.%2%.%3%.%4%"
