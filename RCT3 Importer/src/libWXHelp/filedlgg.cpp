...
bool wxGenericFileDialog::CreatePrepare( wxWindow *parent,
                                  const wxString& message,
                                  const wxString& defaultDir,
                                  const wxString& defaultFile,
                                  const wxString& wildCard,
...
void wxGenericFileDialog::CreateFinish(bool is_pda)
{
    if (!is_pda)
    {
        Centre( wxBOTH );
...
bool wxGenericFileDialog::GetIgnoreChanges()
{
    return ignoreChanges;
}

bool wxGenericFileDialog::SetIgnoreChanges(bool newignore)
{
    bool oldignore = ignoreChanges;
    ignoreChanges = newignore;
    return oldignore;
}
