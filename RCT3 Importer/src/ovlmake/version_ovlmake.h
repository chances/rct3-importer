...
namespace AutoVersion{
	...
	static const long BUILD = 259;									// av::var:post
	static const long REVISION = 988;								// av::var:pre
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT = 975;							// Ignore as cruft
	#define RC_FILEVERSION 0,5,259,988								// av::multi:major:minor:post:pre:"%1%,%2%,%3%,%4%"
	#define RC_FILEVERSION_STRING "0, 5, 259, 988\0"				// av::multi:major:minor:post:pre:"%1%, %2%, %3%, %4%\0"
	static const char FULLVERSION_STRING[] = "0.5.259.988";		// av::multi:major:minor:post:pre:"%1%.%2%.%3%.%4%"
