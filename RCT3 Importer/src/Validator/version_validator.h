...
namespace AutoVersion{
	...
	static const long BUILD = 293;									// av::var:post
	static const long REVISION = 840;								// av::var:pre
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT = 828;							// Ignore as cruft
	#define RC_FILEVERSION 1,0,293,840								// av::multi:major:minor:post:pre:"%1%,%2%,%3%,%4%"
	#define RC_FILEVERSION_STRING "1, 0, 293, 840\0"				// av::multi:major:minor:post:pre:"%1%, %2%, %3%, %4%\0"
	static const char FULLVERSION_STRING[] = "1.0.293.840";		// av::multi:major:minor:post:pre:"%1%.%2%.%3%.%4%"
