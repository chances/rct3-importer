...
static void verror_handler_rnc(int erno,va_list ap)
{
    rnl_verror_handler(erno|ERBIT_RNC,ap);
}
static void verror_handler_rnd(int erno,va_list ap)
{
    rnl_verror_handler(erno|ERBIT_RND,ap);
}
...
void rnl_init(void)
{
    if (!initialized)
    {
        ...
        rn_init();
        rnc_init();
        rnc_verror_handler=&verror_handler_rnc;
        rnd_init();
        rnd_verror_handler=&verror_handler_rnd;
    }
}
