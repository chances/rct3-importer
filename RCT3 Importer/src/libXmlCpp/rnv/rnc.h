...
extern xmlParserInputBufferPtr rnc_open(struct rnc_source *sp,char *fn);
extern int rnc_stropen(struct rnc_source *sp,char *fn,char *s,int len);
extern xmlParserInputBufferPtr rnc_bind(struct rnc_source *sp,char *fn,int fd);
