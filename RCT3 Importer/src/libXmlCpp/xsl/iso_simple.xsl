...
<!--
   ISO_SIMPLE.xsl
   based on ISO_SVRL.xsl, to which the rest of this introduction applies.
...
-->
	...
	<schematronreport title="{$title}" schemaVersion="{$schemaVersion}" >
...
-->
		...
		<axsl:attribute name="brieflocation">
