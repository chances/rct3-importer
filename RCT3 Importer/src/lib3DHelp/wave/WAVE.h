...
public:
	...
	bool OpenRead(std::streambuf* buffer);
	...
	std::istream& GetStream()
		{ return readFile? readFile->stream(): writeFile; };

	RiffFile* GetRiffFile()
		{ return readFile? readFile.get() : 0; };

	bool WriteHeaderToFile(std::ostream& fp);
...
protected:
	boost::shared_ptr<RiffFile> readFile;
